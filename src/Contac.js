...
function Contact() {
  return (
    <section id="Contact" className="center tc pv4 flex flex-wrap">
      ...
      <form class="pa4 black-80 w-100 flex flex-wrap">
        ...
        <button
          type="submit"
          className="f6 b pointer no-underline br-pill ba ph3 pv2 mb2 black"
        >
          Send
        </button>
      </form>
